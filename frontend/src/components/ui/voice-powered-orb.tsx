...
// Shader source is stable — kept at module scope so it never changes identity
// between renders (otherwise the effect below would re-init WebGL + the mic
// on every render).
const vert = /* glsl */ `
...
const frag = /* glsl */ `
  ...
  // --- MealMap light palette: warm terracotta / gold, cream base ---
  const vec3 baseColor1 = vec3(1.000000, 0.478431, 0.270588); // #FF7A45 bright orange
  const vec3 baseColor2 = vec3(0.949020, 0.701961, 0.278431); // #F2B347 gold highlight
  const vec3 baseColor3 = vec3(0.945098, 0.913725, 0.847059); // #F1E9D8 page cream base
...
export const VoicePoweredOrb: FC<VoicePoweredOrbProps> = ({
  ...
  // Voice analysis — returns a 0..1 level from mic RMS.
  const analyzeAudio = () => {
